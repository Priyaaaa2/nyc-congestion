...
def load_panel() -> pd.DataFrame:
    ...
    # Aggregate to city-level weekly totals per vehicle type
    agg = (
        panel
...
def run_counterfactual(df: pd.DataFrame, vtype: str):
    ...
    # ISO week number for matching same week across years
    data["week_of_year"] = (
    ...
    # Match 2025 weeks to same week in 2024
    paired = y2025.join(
    ...
    # Baseline YoY growth from pre-toll years
    ...
    # Average baseline growth rate across both pre-toll year pairs
    ...
    # Counterfactual = 2024 trips × (1 + baseline growth)
    paired["cf_trips"]   = (
    ...
    # T-test: is effect significantly different from zero?
